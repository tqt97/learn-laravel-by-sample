...
use App\Services\Labs\Naive\Concurrency\NaiveInventoryOversellService;
use App\Services\Labs\Production\Concurrency\ProductionInventoryOversellService;

final class InventoryOversellScenario extends BaseLabScenario
{
